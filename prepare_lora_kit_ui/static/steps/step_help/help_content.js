...
export const STEP_HELP = {
  ...
  VaeGateStep: {
    ...
    guidance: [
      ...
      { label: "Original and VAE",
        desc: "Compare the training input with the diagnostic reconstruction to see which shapes, edges, or textures survive compression." },
      { label: "Diff",
        desc: "Shows amplified pixel differences after optional smoothing so changed regions are easier to locate." },
      { label: "Hard Mask",
        desc: "Shows only differences above the Otsu or fallback difference threshold; white means a stronger changed region." },
