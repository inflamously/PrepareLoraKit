...
def run(
    ...
    results["substeps"] = {
        "select_upscale_candidates": {"enabled": "select_upscale_candidates" in enabled},
        "upscale_images": {"enabled": "upscale_images" in enabled},
        "hallucination_check": {"enabled": "hallucination_check" in enabled},
    }
