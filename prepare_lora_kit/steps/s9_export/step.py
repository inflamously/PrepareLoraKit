...
def run(
    ...
    *,
    ...
    enabled = set(enabled_substeps or ["s9_1_diff", "s9_2_export"])
    ...
    report = {
        ...
        "orphaned": list(diff.orphaned),
        "substeps": {
            "s9_1_diff": {"enabled": "s9_1_diff" in enabled},
            "s9_2_export": {"enabled": "s9_2_export" in enabled},
        },
    }
    check_cancel(cancel_check)
